...
<!-- Tenzin: this page auto-shows the single most recent post from
     ...
     to be embedded here too, but that meant anyone clicking through to
     Events for retreat/talk dates got hit with whatever news post was
     featured (e.g. a fundraising pitch) first, possibly for a second
     time. So: News shows the post, Events shows only events.
