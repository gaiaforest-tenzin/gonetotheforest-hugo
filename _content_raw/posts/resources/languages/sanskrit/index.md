...
- An HTML version of Monier Williams: <https://sanskrit.inria.fr/MW/1.html#af2>
- The Sanskrit Heritage dictionary (HTML, in French): <https://sanskrit.inria.fr/DICO/index.fr.html>
- Wikipedia page for Velthuis transliteration (useful when searching the above dictionaries): <https://en.wikipedia.org/wiki/Velthuis>
...
- [Audio: Heart Sutra in Sanskrit](/posts/resources/audio/heart-sutra-in-sanskrit/)
