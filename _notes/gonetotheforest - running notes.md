...
_“I am part of the rainforest protecting myself. I am that part of the rainforest recently emerged into thinking.” — John Seed_ 

Underlying all the symptoms of the environmental crisis is the illusion of separation between humans and the rest of the natural world. As Arne Naess the initiator of the deep ecology movement posits, ecological _ideas_ won’t be enough to save us from our slide into oblivion. What we need instead is an ecological _identity_, an ecological _self_.
...
Resources: basic mindfulness, heart sutra in sanksrit
- [x] Help me draft a news note to acknowledge the Nepal flood disaster (search for info) and direct visitors to my site to donate to https://karuna-shechen.org/en/ 
- [x] lets move news and events up in the nav menu, before resources, so that people flow to attending, then to follow-ups naturally. 
- [x] need to set up a resources page for this recent qi gong video: https://www.youtube.com/watch?v=ClgASzduKH8 -- live at /posts/resources/video/qigong-movement-practice/. Note the video was Private for a while, which would have shown 
- [x] also link to it in follow up for recent events (see lin for description, cam be summarised) -- done twice over. The tag alone makes it appear in the follow-up grids on Coffs Harbour and Kadoorie Farm AND automatically on the IBA Kathmandu event (2026-07-06)
- [x] retag always with underscore -- done, everything is basic_mindfulness now (3 audio resources, the video, the Coffs event, both postgrid calls, the template fallback, all doc examples). 
- [x] why did my write of the resources get re-written also?  please avoid re-writing when I have provided complete text -
- [x] So it still doesn't seem to be what I have been describing. I think it best if the follow consists of A SERIES OF EDITS to the original event post, not a new post in "news" this halves the number of posts on the site to manage. 
...
- [x] These resources could be duplicated, syndicated to my personal site, or vice versa (probably not worth uploading them especially to soundcloud, just have them embedded directly one way o the other) -- added your 6 self-recorded "Embodied Practice" 
...
- [x] we need a better way to connect to my personal site from the main Gaia forest site  - any suggestions?  somewhere in the main menu, either drop down or otherwise would be good...
- [x] Ok, resources such as audio and video lack any context - most should have some information (like a date, description) that would be good to include beside beneath the link in the corresponding resources link oge (e.g. "Adio) At least in abridged form. 
...
- [x] add link to personal site from main site (maybe in main menu as well as on about and bio page ??) 
...
- [x] still you've got that bug where pages show their title twice (one obsidian note title and one hugo title) e.g. "Thank You Thank You Your message has been received. I’ll do my best to respond soon."
...
- [x] the header is looking a little cluttered with all those social links... whats good practice there. 
...
- [x] make news and events one page, rather than needing to click through from news (where there is currently no news) to events via a link.  News section can be a single post displayed, likely a sticky post from the as-yet non-existent posts section. 
- [x] help me to craft a new post for this slot that is a link to the launch of the donation page - maybe can even simply recycle the post from gaia forest website?  not sure of this ius good practice to syndicate - it would save us some worlk! 
